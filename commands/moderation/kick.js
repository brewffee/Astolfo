module.exports.run = async (message, args) => {
    ...
    let kickReason; args[1] ? kickReason = args.slice(1).join(' ').replace(/`/g, '`\u200b').trim() : kickReason = 'No reason provided';
    ...
    try {
        ...
        if (E.message === 'Unknown User' || E.message === 'Unknown Member') {
            ...
            return message.channel.send(errorEmbed.setDescription('You can\'t kick a user who isn\'t in the server!'));
        }
    }
