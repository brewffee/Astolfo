module.exports.run = async (client, message) => {
    ...
    message.channel.send(
        new (require('discord.js').MessageEmbed)()
            ...
            .addField('Planned Features', 'command flags, nick, purge, nekos (local db), mute, warn, softban, promote, demote, v3commands, v4help, welcomer, v4ping, music, cleanchangelog, osu')
